<template>
    <div class="col-span-5 lg:col-span-2 lg:col-start-2 col-start-1">
                ...
                <div class="grid grid-cols-3 gap-5 text-center lg:m-3 m-2">
                    ...
                    <div class="grid grid-cols-6 col-start-3 lg:divide-x gap" role="group">
                        <button v-for="size in product.sizes" :key="size"
                                class="col-span-1 hover:bg-amber-500 hover:text-black focus:bg-amber-500 focus:text-black"
        ...
        <div class="grid grid-cols-5 text-center text-4xl lg:m-5">
            <div id="previousProduct" class="col-start-1 hover:bg-amber-500 hover:text-black" @click="previousProduct">
                &lt;
            </div>
            <button class="hover:bg-amber-500 hover:text-black col-start-3 flex items-center justify-center
        text-center text-xs border border-white rounded-md p-1" @click="addToCart()">
                CHOOSE
            </button>
            <div id="nextProduct" class="col-start-5 hover:bg-amber-500 hover:text-black" @click="nextProduct">&gt;
            </div>
        </div>
