    ...
    >
      ...
      <TransitionGroup>
        ...
        >
          ...
          <div class="">
            <div
              class="text-xs lg:text-xs flex items-center justify-center flex-wrap"
            >
              {{ cartItem.size }}
            </div>
          ...
          <div
            class="text-red-700 text-base lg:flex lg:items-center lg:justify-center"
      ...
      <div class="grid grid-cols-5 lg:grid-cols-10 lg:text-2l py-5">
        <div
          class="col-span-1 lg:col-span-3 col-start-1 lg:col-start-2 text-center lg:text-left"
        >
          {{ totalPrice }} €
        </div>
